...
class TestRegistration:
    ...
    def test_registration_new_account_success_submit(self, driver):
        ...
        driver.find_element(*Locators.input_email).send_keys('alexander_cheremisov_13_888@mail.ru')
        driver.find_element(*Locators.input_password).send_keys('281077')
        driver.find_element(*Locators.button_register_2).click()
        WebDriverWait(driver, 10).until(expected_conditions.visibility_of_element_located(Locators.button_register_2))
